...
def publisher():
    ...
    path.poses.append(_pose_stamp(0.0, 0.0, 90))
    path.poses.append(_pose_stamp(7.5, 0.0, 180))
    # path.poses.append(_pose_stamp(7.5, 2.0, -1.5708))
    path.poses.append(_pose_stamp(7.5, 5.0, 180))
    path.poses.append(_pose_stamp(7.5, 9.0, 160))
    path.poses.append(_pose_stamp(8.0, 11.0, 135))
    path.poses.append(_pose_stamp(10.0, 12.0, -0.523599))
    path.poses.append(_pose_stamp(9.0, 13.0, -0.523599))
    path.poses.append(_pose_stamp(9.0, 13.0, -0.523599))
    path.poses.append(_pose_stamp(7.5, 10.0, -0.523599))    # path.poses.append(_pose_stamp(7.5, 10.0, -4.71239))
